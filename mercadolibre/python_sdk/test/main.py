...
import requests
import json
from mercadolibre.python_sdk.lib.meli import Meli
...
class MeliTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.meli = Meli(client_id=self.CLIENT_ID, client_secret=self.CLIENT_SECRET, access_token=self.ACCESS_TOKEN,
    ...
    def testAuthUrl(self):
        ...
        self.assertTrue(
            re.search("^https\:\/\/auth.mercadolibre.com\/authorization", self.meli.auth_url(redirect_URI=callback)))
    ...
    def testPost(self):
        body = {"condition": "new", "warranty": "60 dias", "currency_id": "BRL", "accepts_mercadopago": True,
                "description": "Lindo Ray_Ban_Original_Wayfarer", "listing_type_id": "bronze",
                "title": "oculos Ray Ban Aviador  Que Troca As Lentes  Lancamento!", "available_quantity": 64,
                "price": 289, "subtitle": "Acompanha 3 Pares De Lentes!! Compra 100% Segura",
                "buying_mode": "buy_it_now", "category_id": "MLB5125", "pictures": [
